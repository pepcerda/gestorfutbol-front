  ...
  const items = [
    {
      ...
      template: () => {
        return (
          <NavLink to={"/home"} className="sidenav-item p-menuitem-link">
    ...
    },
    {
      ...
      template: () => {
        return (
          <NavLink to={"/campanya"} className="sidenav-item p-menuitem-link">
    ...
    },
    {
      template: () => {
        return (
          <span className="p-menuitem-link sidenav-item">
      ...
      items: [
        ...
        },
        {
          ...
          template: () => {
            return (
              <NavLink to={"/quotes-jugadors"} className="p-menuitem-link">
          ...
          template: () => {
            return (
              <NavLink to={"/factures"} className="p-menuitem-link">
                <span className="p-menuitem-icon pi pi-fw pi-money-bill fs-2"></span>
                <span className="p-menuitem-text">{t("t.factures")}</span>
              </NavLink>
            );
          },
        },
          ...
          template: () => {
            return (
              <NavLink to={"/mensualitats"} className="p-menuitem-link">
                <span className="p-menuitem-icon pi pi-fw pi-file fs-2"></span>
          ...
          template: () => {
            return (
              <NavLink to={"/tiquets"} className="p-menuitem-link">
                <span className="p-menuitem-icon pi pi-fw pi-ticket fs-2"></span>
...

    {
      template: () => {
        return (
          <span className="p-menuitem-link sidenav-item">
            <span className="p-menuitem-icon pi pi-fw pi-users fs-2"></span>
            <span className="p-menuitem-text fw-bold">
              {t("t.administracio")}
            </span>
            <svg
              width="14"
